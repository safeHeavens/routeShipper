...
export default function AdminShipments() {
    ...
    const statusMap: Record<string, string> = {
        "Label Created": "Shipment Created",
        "Pickup Created": "Pickup Scheduled",
        "In Transit": "In Air Transit",
        "Arrived at Hub": "At Local Distribution Hub",
        "With Customs": "Customs Clearance",
        "At Customs": "Customs Clearance",
    ...
    const openUpdateModal = (shipment: any) => {
        ...
        setUpdateForm({
            ...
            description:
                ...
                `Shipment is currently ${currentStatus.toLowerCase()}.`,
    ...
    const handleQuickUpdate = async () => {
        ...
        const { error: shipError } = await supabase
            ...
            .update({
                ...
                event_location: updateForm.location
            })
                            ...
                            <Select value={updateForm.status} onValueChange={(v) => setUpdateForm({...updateForm, status: v})}>
                                ...
                                <SelectContent className="bg-white">
                                    <ScrollArea className="h-72">
                                        ...
                                        <SelectItem value="Processing at Origin">Processing at Origin</SelectItem>
                                        <SelectItem value="Ready for Air Dispatch">Ready for Air Dispatch</SelectItem>
                                        <SelectItem value="Departed Origin Airport">Departed Origin Airport</SelectItem>
                                        <SelectItem value="In Air Transit">In Air Transit</SelectItem>
                                        <SelectItem value="Arrived at Destination Airport">Arrived at Destination Airport</SelectItem>
                                        <SelectItem value="Customs Clearance">Customs Clearance</SelectItem>
                                        <SelectItem value="Released from Customs">Released from Customs</SelectItem>
                                        <SelectItem value="At Local Distribution Hub">At Local Distribution Hub</SelectItem>
